...
try: import requests
    ...
    print("\nInstalling requests.")
    print("If this fails please install requests manually using pip.")

    try: subprocess.check_call([sys.executable, "-m", "pip", "install", "requests"])
    except:
        print("\nFailed installing requests!\n")
        traceback.print_exc()
        print("\nPlease install requests using pip")
        exit()
