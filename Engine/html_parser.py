...
class HTMLParser:
    ...
    def populateElementTree(self, tag: element.Tag) -> None:

        nodeStack: List[Tuple[element.Tag, Element, int, int]] = [(tag, self.document.html_element, 0, 0)]
    ...
    def parseHTML(self, html: str, thread_id: int = 0) -> Document | None:
        ...
        self.populateElementTree(first_elem)
