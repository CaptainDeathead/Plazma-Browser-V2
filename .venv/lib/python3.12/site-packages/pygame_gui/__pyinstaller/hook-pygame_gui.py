...
_append_to_datas("data/NotoSans-Italic.ttf")
_append_to_datas("data/NotoSans-Regular.ttf")
_append_to_datas("data/NotoSansArabic-Bold.ttf")
_append_to_datas("data/NotoSansArabic-Regular.ttf")
_append_to_datas("data/NotoSansGeorgian-Bold.ttf")
_append_to_datas("data/NotoSansGeorgian-Regular.ttf")
_append_to_datas("data/NotoSansHebrew-Bold.ttf")
_append_to_datas("data/NotoSansHebrew-Regular.ttf")
_append_to_datas("data/NotoSansJP-Bold.otf")
_append_to_datas("data/NotoSansJP-Regular.otf")
_append_to_datas("data/NotoSansKR-Bold.ttf")
_append_to_datas("data/NotoSansKR-Regular.ttf")
...
_append_translations_to_datas("data/translations/pygame-gui.ar.json")
...
_append_translations_to_datas("data/translations/pygame-gui.ge.json")
_append_translations_to_datas("data/translations/pygame-gui.he.json")
